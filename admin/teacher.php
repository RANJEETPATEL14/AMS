	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "well col-lg-12">
				<button class = "btn btn-success" type = "button" href = "#" data-toggle = "modal" data-target = "#add_teacher"><span class = "glyphicon glyphicon-plus"></span> Add new </button>
				<br />
				<br />
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $f_teacher['firstname']?></td>
							<td><?php echo $f_teacher['lastname']?></td>
							<td><?php echo $f_teacher['course']?></td>
							<td><?php echo $f_teacher['password']?></td>
							<td><a class = "btn btn-danger rteacher_id" name = "<?php echo $f_teacher['teacher_id']?>" href = "#" data-toggle = "modal" data-target = "#delete"><span class = "glyphicon glyphicon-remove"></span></a> <a class = "btn btn-warning  eteacher_id" name = "<?php echo $f_teacher['teacher_id']?>" href = "#" data-toggle = "modal" data-target = "#edit_teacher"><span class = "glyphicon glyphicon-edit"></span></a></td>
						</tr>
						<?php
							}
						?>
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.eteacher_id').click(function(){
				$teacher_id = $(this).attr('name');
				$('#edit_query').load('load_edit2.php?teacher_id=' + $teacher_id);
			});
		});
	</script>
</html>