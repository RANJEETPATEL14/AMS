	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px; margin-left:600px;">
			<ul class = "nav nav-pills">
				<li><a href = "../teacher/index.php"><span class = "glyphicon glyphicon-education"></span> Teacher</a></li>
				<li class="active"><a href = "home.php"><span class = "glyphicon glyphicon-user"></span> Student</a></li>
